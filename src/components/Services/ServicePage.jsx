...
const ServicePage = ({ service, onClose }) => {
  ...
  // Prevent background scroll and only close modal when actual backdrop is clicked
  ...
  // SHARE FUNCTION: mobile/desktop fix
  const handleShare = async (e) => {
    if (e) e.stopPropagation();
    const title = service?.title || "Check this out!";
    const text = service?.subtitle || "";
        ...
        >
          ...
          <div className="p-4 sm:p-6 lg:p-8 overflow-y-auto max-h-[95vh]">
                ...
                <div className="flex flex-col gap-2 mb-2">
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-4">
                    ...
                    <button
                      type="button"
                      onClick={handleShare}
                      className="px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium border bg-black bg-opacity-20 border-gray-400 border-opacity-30 text-white hover:border-[#00FFAB] hover:text-[#00FFAB] transition-all duration-200 flex items-center gap-1 flex-shrink-0"
                      style={{ zIndex: 1000, position: 'relative', touchAction: 'manipulation' }}
                    >
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-xl font-semibold text-center mb-3 sm:mb-4 text-[#00FFAB]">Gallery</h3>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
              ...
              <div className="bg-black border border-gray-700 p-3 sm:p-4 rounded-xl text-center hover:border-[#00FFAB] hover:border-opacity-50 transition-all duration-200">
                <div className="text-xs sm:text-sm text-white mb-1">Difficulty</div>
                <div className="font-semibold text-[#00FFAB] text-sm sm:text-base truncate">{service.difficulty}</div>
              </div>
            </div>

            {/* Skills Section */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-[#00FFAB]">Skills You'll Develop</h3>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8">
              <div className="bg-black border border-gray-700 p-4 sm:p-6 rounded-xl">
                <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-[#00FFAB]">What's Included</h3>
              ...
              <div className="bg-black border border-gray-700 p-4 sm:p-6 rounded-xl">
                <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4 text-[#00FFAB]">Requirements</h3>
                <div className="space-y-2 sm:space-y-3">
            ...
            {/* How It Works */}
            <div className="mb-6 sm:mb-8">
              <h3 className="text-lg sm:text-xl font-semibold mb-3 sm:mb-4 text-[#00FFAB]">How It Works</h3>
              <div className="bg-black border border-gray-700 p-4 sm:p-6 rounded-xl">
