...
const BlogPost9 = () => {
  ...
  const [showShareSection, setShowShareSection] = useState(false); // computed, but right sidebar share removed
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <div className="lg:w-1/4 lg:flex flex-col hidden space-y-6">
            <div className="sticky top-24">
              {/* Table of Contents */}
              <div className="bg-gradient-to-br from-black to-black/90 backdrop-blur-xl p-3 rounded-2xl border border-[#00FFAB]/30 shadow-2xl mb-6">
